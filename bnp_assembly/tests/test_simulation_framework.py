...
def test_generate_training_from_contig_sizes_big():
    ...
    input_data, sg, contig_positions = generate_training_from_contig_sizes(big_scaffold_assembly, n_reads=1000)
    ...
    #                                                                                  contig_positions.b)))
    # create_heatmap_figure(agp, 1000, genome, scaffold_pair)[0]
